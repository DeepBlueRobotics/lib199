...
public class SwerveModule implements Sendable {
    ...
    public SwerveModule(SwerveConfig config, ModuleType type, CANSparkMax drive, CANSparkMax turn, CANcoder turnEncoder,
        ...
        MagnetSensorConfigs rangeConfig = new MagnetSensorConfigs();
        // WARNING: Signed_PlusMinusHalf != Signed-PlusMinus180 (Phoenix 6 does not provide PlusMinus180)
        rangeConfig.AbsoluteSensorRange = AbsoluteSensorRangeValue.Signed_PlusMinusHalf;
        this.turnEncoder.getConfigurator().apply(rangeConfig);
