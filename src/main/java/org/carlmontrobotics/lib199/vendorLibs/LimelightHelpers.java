/*
docs: https://docs.limelightvision.io/docs/docs-limelight/apis/limelight-lib
code: https://github.com/LimelightVision/limelightlib-wpijava/blob/main/LimelightHelpers.java
*/
